<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex navbar-brand text-wrap" href="<?php echo e(route('dashboard')); ?>">
    ...
    <div style="height: 100%" class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link <?php echo e((Request::is('customer-services*') ? 'active' : '')); ?>"
                   href="<?php echo e(route('customer_services.index')); ?>">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>customer-support</title>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link <?php echo e((Request::is('customer-schedules*') ? 'active' : '')); ?>"
                   href="<?php echo e(route('customer_schedules.index')); ?>">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>customer-support</title>
            ...
            <?php if(auth()->user()->role != 3): ?>
                ...
                <?php if(auth()->user()->role == 1): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((Request::is('agencies*') ? 'active' : '')); ?>"
                           href="<?php echo e(route('agencies.index')); ?>">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e((Request::is('transactions*') ? 'active' : '')); ?>"
            ...
            <?php if(auth()->user()->role === 1): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e((Request::is('pages*') ? 'active' : '')); ?>" href="<?php echo e(route('pages.index')); ?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>customer-support</title>
...
<?php /**PATH /var/www/resources/views/layouts/navbars/auth/sidebar.blade.php ENDPATH**/ ?>