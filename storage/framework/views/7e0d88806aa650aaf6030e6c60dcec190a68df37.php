        ...
        <div class="container-fluid py-4">
            <div class="row mb-4">
                ...
                <div class="col-6 text-end">
                    <a href="<?php echo e(route('users.create')); ?>" class="btn bg-gradient-success">
                                    ...
                                    <?php if(count($users) > 0): ?>
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <a
                                                                    href="<?php echo e(route('users.edit', ['user_id' =>$user->id])); ?>"
                                                                    class="mb-0 text-sm label-name"><?php echo e($user->name); ?></a>
                                                            <p class="text-xs text-secondary mb-0"><?php echo e($user->phone); ?></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?php echo e($user->gender ? 'Nam' : 'Nữ'); ?></p>
                                                    <p class="text-xs text-secondary mb-0"><?php echo e($user->agency ? $user->agency->name : ''); ?></p>
                                                </td>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span class="text-xs font-weight-bold mb-0"><?php echo e($user->created_at->format('d/m/Y')); ?></span>
                                                </td>
                                                <td class="align-middle">
                                                    <a href="<?php echo e(route('users.edit', ['user_id' => $user->id])); ?>"
                                                    ...
                                                    <?php if(!$user->is_protected): ?>
                                                        ...
                                                        <form action="<?php echo e(route('users.destroy', ['user_id' => $user->id])); ?>"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("resetPassword").addEventListener("click", function() {
                ...
                fetch("<?php echo e(route('change.changePassword')); ?>", {
                    method: "POST",
                    headers: {
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/users/index.blade.php ENDPATH**/ ?>