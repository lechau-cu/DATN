                ...
                <li class="nav-item dropdown d-flex align-items-center">
                    <a class="nav-link dropdown-toggle text-body font-weight-bold px-0" href="#" id="userDropdown"
                       role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-person"></i> <span class="d-sm-inline d-none"><?php echo e(auth()->user()->name); ?></span>
                    </a>
                    <!-- Dropdown Menu -->
...
<!-- End Navbar --><?php /**PATH /var/www/resources/views/layouts/navbars/auth/nav.blade.php ENDPATH**/ ?>